                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <div class="d-flex mb-2 me-2">
                                        <button class="mr-1 btn btn-outline-dark btn-sm"
                                            onclick="editAddress({{ $address->id }})" type="button">
                                            {{ $address->label }}
                                        </button>
                                        <form action="{{ route('account.address.delete', $address->id) }}"
                ...
                <div class="tab-content" id="accountTabContent">
                    ...
                    <div class="tab-pane fade show active" id="pesanan" role="tabpanel">
                        ...
                        <div class="card p-3 mb-2">
                            ...
                            <p>{{ $order->created_at->format('d M Y') }} • Total: Rp
                        ...
                        <div class="card p-3 mb-2">
                            ...
                            <div class="d-flex gap-2">
                                <a class="btn btn-sm btn-info"
                                    href="{{ route('product.detail', $order->orderItems->first()->product->slug ?? '#') }}">Beli
                                    Lagi</a>
                                <button class="btn btn-sm btn-warning"
                                    data-target="#reviewModal{{ $order->id }}" data-toggle="modal">
                                    Beri Nilai
                                </button>
                            </div>
                        </div>
