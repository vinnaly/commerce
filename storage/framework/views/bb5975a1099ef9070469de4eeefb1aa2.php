							...
							<?php if($orders->where("status", "!=", "completed")->count()): ?>
								<?php $__currentLoopData = $orders->where("status", "!=", "completed"); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="card p-3 mb-2">
										...
										<p>Status: <span class="badge badge-warning"><?php echo e(ucfirst($order->status)); ?></span></p>
...
<?php echo $__env->make("frontend.layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\E-commercekucopy\resources\views/frontend/account/index.blade.php ENDPATH**/ ?>