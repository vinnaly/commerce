        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center">
                            ...
                            <form action="<?php echo e(route('account.picture')); ?>" enctype="multipart/form-data" method="POST">
                                ...
                                <button class="btn btn-outline-secondary btn-sm btn-block" type="submit">Upload
                                    Foto</button>
                            </form>
                            <?php if(auth()->user()->profile_picture): ?>
                            <form action="<?php echo e(route('account.delete-picture')); ?>" method="POST">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                <button class="btn btn-sm btn-danger btn-block mt-2" type="submit">Hapus
                                    Foto</button>
                            </form>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a class="btn btn-sm btn-outline-primary" data-target="#gantiPasswordModal"
                                    data-toggle="modal" href="#">Ganti Password</a>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <div class="d-flex mb-2 me-2">
                                        <button class="mr-1 btn btn-outline-dark btn-sm"
                                            onclick="editAddress(<?php echo e($address->id); ?>)" type="button">
                                            <?php echo e($address->label); ?>

                                        </button>
                                        <form action="<?php echo e(route('account.address.delete', $address->id)); ?>"
                                            class="ms-1" method="POST">
                                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                ...
                                <button class="btn btn-outline-dark btn-sm mt-2" onclick="addNewAddress()"
                                    type="button">Tambah Alamat</button>
                ...
                <ul class="nav nav-tabs mb-3" id="accountTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#pesanan" id="pesanan-tab"
                            role="tab">Pesanan Saya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#riwayat" id="riwayat-tab" role="tab">Riwayat
                            Pesanan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#ulasan" id="ulasan-tab" role="tab">Ulasan
                            Saya</a>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="accountTabContent">
                    ...
                    <div class="tab-pane fade show active" id="pesanan" role="tabpanel">
                        ...
                        <div class="card p-3 mb-2">
                            ...
                            <p><?php echo e($order->created_at->format('d M Y')); ?> • Total: Rp
                                <?php echo e(number_format($order->total, 0, ',', '.')); ?>

                            </p>
                            <p>Status: <span
                                    class="badge badge-warning"><?php echo e(ucfirst($order->payment_status)); ?></span>
                            </p>
                        ...
                        <div class="card p-3 mb-2">
                            ...
                            <div class="d-flex gap-2">
                                <a class="btn btn-sm btn-info"
                                    href="<?php echo e(route('product.detail', $order->orderItems->first()->product->slug ?? '#')); ?>">Beli
                                    Lagi</a>
                                <button class="btn btn-sm btn-warning"
                                    data-target="#reviewModal<?php echo e($order->id); ?>" data-toggle="modal">
                                    Beri Nilai
                                </button>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            <form action="<?php echo e(route('account.password')); ?>" method="POST">
                ...
                <div class="modal-body">
                    <input class="form-control mb-2" name="current_password" placeholder="Password Lama" required
                        type="password">
                    <input class="form-control mb-2" name="new_password" placeholder="Password Baru" required
                        type="password">
                    <input class="form-control" name="new_password_confirmation"
                        placeholder="Konfirmasi Password Baru" required type="password">
                </div>
            ...
            <form action="<?php echo e(route('account.address.add')); ?>" id="addressForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" id="label" name="label" placeholder="Rumah, Kantor, dll"
                            required type="text">
                    </div>
                        ...
                        <div class="mt-2" id="selected_destination" style="display: none;">
                            ...
                            <div class="alert alert-info py-2 mb-0">
                                ...
                                <button class="btn btn-sm btn-outline-secondary float-right"
                                    onclick="clearDestinationSelection()" type="button">Ubah</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" id="zip" name="zip" placeholder="Kode Pos"
                            type="text">
                    </div>

                    <div class="form-group mb-3">
                        <label for="phone">Nomor Telepon</label>
                        <input class="form-control" id="phone" name="phone" placeholder="Nomor Telepon"
                            type="text">
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function searchDestinations(query) {
            ...
            try {
                ...
                const response = await fetch(
                    `/api/destinations/search?keyword=${encodeURIComponent(query)}`, {
                        method: 'GET',
                        headers: {
        ...
        function displaySearchResults(destinations) {
            ...
            destinations.forEach(destination => {
                ...
                const destinationId = destination.destination_id || destination.city_id || destination
                    .id;
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Tutik_TSH\resources\views/frontend/account/index.blade.php ENDPATH**/ ?>